...
public class MajordomoClientV2 {
    ...
    public MajordomoClientV2(String broker, boolean verbose) {
        this.broker = broker;
    ...
    void reconnectToBroker() {
        ...
        client.setIdentity("clientV2".getBytes(StandardCharsets.UTF_8));
    ...
    public boolean send(String service, ZMsg request) {
        ...
        // Frame 1: "MDPCxy" (six bytes, MajordomoProtocol/Client x.y)
        // Frame 2: Service name (printable string)
        request.addFirst(service);
        request.addFirst(MajordomoProtocol.C_CLIENT.newFrame());
        request.addFirst("");
        if (verbose) {
